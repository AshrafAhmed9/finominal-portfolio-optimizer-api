...
scenarios from the assignment brief. **Not yet populated** - capturing them
requires a human running the live tool at
https://finominal.com/portfolio-optimizer/US, which this build could not do
(account creation on the live tool failed; see the main README).
